#!/bin/bash
# move-goldsen-to-test.sh - goldsen site victoria01 to victoria02

SOURCE_PATH=/libweb/sites/goldsen.library.cornell.edu/htdocs
SOURCE_MACHINE=victoria01.library.cornell.edu
TARGET_PATH=/libweb/sites/goldsen.test.library.cornell.edu/htdocs
SITE_NAME=goldsen
HOST_MACHINE="victoria02.serverfarm.cornell.edu"
...
message "This will move the goldsen site from victoria01 (production) to victoria02 (test)"
ConfirmOrExit
...
#  --dry-run to test
message "moving files to target"
sudo rsync -rltgoDvc -e ssh --delete --exclude=$DRUPAL_PATH/sites/ \
