#!/bin/bash
# update_test_from_victoria03.sh - move the site from production
# run this on test server
### svn:keyword $Date: 2013-12-18 15:34:55 -0500 (Wed, 18 Dec 2013) $
### svn:keyword $Author: jgr25 $
### svn:keyword $Rev: 2012 $
