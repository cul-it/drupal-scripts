#!/bin/bash
# update_victoria03_from_test.sh - move the site from test
# run this on production server
### svn:keyword $Date: 2013-12-18 15:35:12 -0500 (Wed, 18 Dec 2013) $
### svn:keyword $Author: jgr25 $
### svn:keyword $Rev: 2013 $
...
HOST_MACHINE="victoria03.library.cornell.edu"
